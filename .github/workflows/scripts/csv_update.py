...
if __name__ == "__main__":
    prefix_file_name = _update_file(
        src_prefix="KEY TO ABBREVIATIONS AND BSB NUMBERS", src_type=".csv", dest="static/bsb_prefix_rules.csv"
    )
    directory_file_name: str = _update_file(src_prefix="BSBDirectory", src_type=".csv", dest="static/bsb_directory.csv")
